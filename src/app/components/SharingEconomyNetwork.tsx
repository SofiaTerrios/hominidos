    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 flex flex-col items-center justify-center p-4 overflow-hidden py-32">
      ...
      <div className="text-center mb-8 z-10">
        ...
        <p className="text-xl text-gray-300 mb-2">
          Plataformas conectadas que transforman la forma en que compartimos
          recursos
        </p>
          ...
          <div key={company.name}>
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none">
              ...
              {pulseIndex === index &&
                ...
                (() => {
                  const path = `M ${window.innerWidth / 2} ${200} L ${
                    (company.position.x / 700) * window.innerWidth
                  } ${(company.position.y / 600) * 400}`;
                  return (
